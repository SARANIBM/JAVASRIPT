...
const arr1=[4,6,2,3,1,1,3,8,7,3,4,5]
const duplicate = arr1.filter((val,ind,num) =>{
    return arr1.indexOf(val)===ind
})
console.log(duplicate)

// ROBERT ANDREW GEORGE = RAG

str = 'Robert Andrew George'
let arr2 = str.split(' ')
console.log(arr2)
str2=''
const arr3 = arr2.map((x,i,a)=>{
    str2=str2+x.charAt(0)
})
console.log(str2)
...
let s=0
let posnum = i.reduce((accumulator,val) =>{
